...
void process()
{
    while (true)
    {
        ...
        for (auto &measurement : measurements)
        {
            ...
            static TicToc t_fsel("MH_01_easy_selection_time_select_traceofinv_randomized_H10");
            t_fsel.tic();
            ...
            static TicToc kian_timer("MH_01_easy_backend_time_select_traceofinv_randomized_H10");
            kian_timer.tic();
